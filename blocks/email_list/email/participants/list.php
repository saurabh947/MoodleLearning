<?php
  ...
  //si no se li passa res, mostrar� tots els contactes accessibles pel curs
  //per la resta �s una m�dul normal de Moodle
...
$PAGE->set_title(get_string('contacts','email'));
echo $OUTPUT->header();
