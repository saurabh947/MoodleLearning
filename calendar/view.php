...
//$lightbox = $DB->get_record('event', array("courseid" => $courseid,"lightbox" => 1), $fields='lightbox', $strictness=IGNORE_MISSING);

$sql = 'SELECT lightbox FROM mdl_event WHERE courseid='.$courseid.' AND userid='.$USER->id;
$lightbox = $DB->get_record_sql($sql, null, $strictness=IGNORE_MISSING);
...
<html>
<body>
	<div> <a href="<?php echo "../course/modedit.php?add=lightboxgallery&type=&course=".$courseid."&section=".$sectionid."&return=0&sr=0"  ?>" style="text-decoration:none; text-align:center;"> Add Lightbox Gallery </a> 
    </div>
</body>
</html>
...
//echo "<div> <a> Add Lightbox Images </a> </div>";
