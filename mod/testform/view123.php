...
/**
 * Prints a particular instance of testform
 *
...
if ($testform->intro) { // Conditions to show the intro can change to look for own settings or whatever
    echo $OUTPUT->box(format_module_intro('testform', $testform, $cm->id), 'generalbox mod_introbox', 'testformintro');
}
